            ...
            {!helpHidden && (
                <div className="help-content-container">
                    <div className="help-content">
                        ...
                        <p>
                            For default searches, ClimateTree&trade; maps all places that are between 90% and 150% of the population of your place. For example if you live in a place with 100,000 people, ClimateTree&trade; will fetch any places with a population between 90,000 and 150,000. This range of similarity stretches higher than lower to account for anticipated population growth or in-migration. Feel free to customize your own notion of “similarity” with the Advanced Search features.
                        </p>
                        <p>
