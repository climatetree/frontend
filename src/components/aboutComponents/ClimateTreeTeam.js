...
const ClimateTreeTeam = () => {
  return (
    <div class="wrapper">
      <h1>Meet Our Team</h1>

      <div className="neu-climate-logos">
        <div>
      ...
      <div class="our_team">
        ...
        <div class="team_member">
          <div class="member_img">
            ...
            <div class="social_media">
              <a href="https://www.linkedin.com/in/abbyruskey/" target="_blank">
                <i class="linkedin fab fa-linkedin"></i>
              </a>
            </div>
          </div>
        ...
        <div class="team_member">
          <div class="member_img">
            <img src={yuyou} alt="our_team" />
            <div class="social_media">
              <a
                href="https://www.linkedin.com/in/yuyou-fan-58085a18b/"
                target="_blank"
              >
                <i class="linkedin fab fa-linkedin"></i>
              </a>
...
export default ClimateTreeTeam;
